...
public abstract class Camera2BasicFragment extends Fragment implements View.OnClickListener {
    ...
    private final TextureView.SurfaceTextureListener mSurfaceTextureListener
        ...
        public void onSurfaceTextureAvailable(SurfaceTexture texture, int width, int height) {
            Log.d(TAG, "mSurfaceTextureListener available with w and d: " + width + ", " + height);
            openCamera(width, height);
        }

        @Override
        public void onSurfaceTextureSizeChanged(SurfaceTexture texture, int width, int height) {
            Log.d(TAG, "mSurfaceTextureListener changed to w and d: " + width + ", " + height);
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            Log.d(TAG, "mTextureView available onResume.");
    ...
    protected abstract void notifyCaptureCompletion();
    ...
    private void captureStillPicture() {
        try {
            Log.d(TAG, "capturingStillPicture.");
            final Activity activity = getActivity();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.picture: {
                Log.d(TAG, "Capture request received.");
                takePicture();
                break;
            }
            case R.id.info: {
